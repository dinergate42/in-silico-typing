...
# @version 1.1 (06.06.2021) --- comments added to improve usablity
...
# Parameters are used as switches.
# Use 'mode' to select the folder for reference data or your own input folder.
# Use 'pcr' to select the desired analysis. For in-silico MLVA16 use 'MLVA16'.
# If desired, this selection can be saved in an ini file or used as a parameter in a command line call.
mode = 'Own'    # Ref, Own
...
# This section contains the location of the files. However, this could also be moved out to an ini file if more convenient.
